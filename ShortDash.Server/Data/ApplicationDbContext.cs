    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        private List<DashboardAction> SeedDashboardActions()
        {
            ...
            return new List<DashboardAction> {
                ...
                new DashboardAction() { DashboardActionId = 4, DashboardActionTargetId = 1, Title = "Mute", BackgroundColor = Color.CornflowerBlue, Icon = "open-iconic/svg/ban.svg", ActionTypeName="Media.Mute", Parameters = "{\"IsToggle\":true}" },
                new DashboardAction() { DashboardActionId = 5, DashboardActionTargetId = 1, Title = "Prev", BackgroundColor = Color.Gray, ActionTypeName="Media.Previous" },
                new DashboardAction() { DashboardActionId = 6, DashboardActionTargetId = 1, Title = "Play", BackgroundColor = Color.DarkBlue, ActionTypeName="Media.Play" },
                new DashboardAction() { DashboardActionId = 7, DashboardActionTargetId = 1, Title = "Next", BackgroundColor = Color.SeaGreen, ActionTypeName="Media.Next" },
