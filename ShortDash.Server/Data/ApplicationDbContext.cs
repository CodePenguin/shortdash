    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        private List<DashboardAction> SeedDashboardActions()
        {
            ...
            return new List<DashboardAction>
            {
                ...
                new DashboardAction() { DashboardActionId = 6, DashboardActionTargetId = 1, Title = "Play", BackgroundColor = Color.DarkBlue, ActionTypeName = "ShortDash.Plugins.Core.Windows.MediaPlayPauseAction" },
