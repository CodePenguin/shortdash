    ...
    public class ApplicationDbContext : DbContext
    {
        ...
        private List<DashboardAction> SeedDashboardActions()
        {
            ...
            return new List<DashboardAction>
            {
                ...
                new DashboardAction() { DashboardActionId = 10, DashboardActionTargetId = 1, Label = "Multi", Icon = "oi-project.png", ActionTypeName = "ShortDash.Server.Actions.DashGroupAction" },
