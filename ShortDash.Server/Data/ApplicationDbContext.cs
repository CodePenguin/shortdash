...
namespace ShortDash.Server.Data
{
    public class ApplicationDbContext : DbContext
    {
        ...
        private List<DashboardAction> SeedDashboardActions()
        {
            ...
            {
                new DashboardAction() { DashboardActionId = 1, DashboardActionTargetId = 1, Label = "Twitter", Icon = "Twitter.png", ActionTypeName = "ShortDash.Plugins.Core.Common.ExecuteProcessAction", Parameters = "{\"FileName\":\"https://twitter.com\"}" },
                new DashboardAction() { DashboardActionId = 2, DashboardActionTargetId = 1, Label = "Discord", Icon = "Phone.png", ActionTypeName = "ShortDash.Plugins.Core.Common.ExecuteProcessAction", Parameters = "{\"FileName\":\"https://discord.com\"}" },
                new DashboardAction() { DashboardActionId = 3, DashboardActionTargetId = 1, Label = "Slack", BackgroundColor = Color.Gray, Icon = "Mail.png", ActionTypeName = "ShortDash.Plugins.Core.Common.ExecuteProcessAction", Parameters = "{\"FileName\":\"https://slack.com\"}" },
                new DashboardAction() { DashboardActionId = 4, DashboardActionTargetId = 1, Label = "Mute", BackgroundColor = Color.CornflowerBlue, Icon = "fas fa-volume-mute", ActionTypeName = "ShortDash.Plugins.Core.Windows.MediaMuteAction", Parameters = "{\"IsToggle\":true}" },
                ...
                new DashboardAction() { DashboardActionId = 6, DashboardActionTargetId = 1, Label = "Play", BackgroundColor = Color.DarkBlue, Icon = "fas fa-play", ActionTypeName = "ShortDash.Plugins.Core.Windows.MediaPlayPauseAction" },
                ...
                new DashboardAction() { DashboardActionId = 8, DashboardActionTargetId = 1, Label = "Notepad", Icon = "Settings.png", ActionTypeName = "ShortDash.Plugins.Core.Common.ExecuteProcessAction", Parameters = "{\"FileName\":\"c:\\\\windows\\\\Notepad.exe\",\"Arguments\":\"d:\\\\temp\\\\temp.txt\",\"WorkingDirectory\":\"c:\\\\windows\\\\\"}" },
                new DashboardAction() { DashboardActionId = 9, DashboardActionTargetId = 1, Label = "Batch", BackgroundColor = Color.LavenderBlush, Icon = "Maps.png", ActionTypeName = "ShortDash.Plugins.Core.Common.ExecuteProcessAction", Parameters = "{\"FileName\":\"test.batch\"}" },
                new DashboardAction() { DashboardActionId = 10, DashboardActionTargetId = 1, Label = "Multi", Icon = "fas fa-project-diagram", ActionTypeName = "ShortDash.Server.Actions.DashGroupAction" },
                new DashboardAction() { DashboardActionId = 11, DashboardActionTargetId = 1, Label = "Dash 2", BackgroundColor = Color.LightSeaGreen, Icon = "fas fa-grip-horizontal", ActionTypeName = "ShortDash.Server.Actions.DashLinkAction", Parameters = "{\"DashboardId\":2}" },
                new DashboardAction() { DashboardActionId = 12, DashboardActionTargetId = 1, Label = "Dash 3", BackgroundColor = Color.SpringGreen, Icon = "fas fa-grip-horizontal", ActionTypeName = "ShortDash.Server.Actions.DashLinkAction", Parameters = "{\"DashboardId\":3}" },
                ...
                new DashboardAction() { DashboardActionId = 14, DashboardActionTargetId = 2, Label = "Mute2", BackgroundColor = Color.CornflowerBlue, Icon = "fas fa-volume-mute", ActionTypeName = "ShortDash.Plugins.Core.Windows.MediaMuteAction", Parameters = "{\"IsToggle\":true}" },
            };
        }
