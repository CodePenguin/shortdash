...
namespace ShortDash.Server.Components
{
    public class ActionTypeInputSelect : InputBase<string>
    {
        ...
        private List<KeyValuePair<string, string>> AvailableActions { get; } = new List<KeyValuePair<string, string>>();
        ...
        protected override void OnParametersSet()
        {
            ...
            foreach (var actionType in actionTypes)
            {
                ...
                AvailableActions.Add(new KeyValuePair<string, string>(actionType.FullName, title));
            }
            AvailableActions.Sort((a, b) => a.Value.CompareTo(b.Value));
            if (string.IsNullOrWhiteSpace(CurrentValueAsString))
            {
                CurrentValueAsString = AvailableActions.FirstOrDefault().Key;
        ...
        {
            var selectedItem = AvailableActions.FirstOrDefault(p => p.Key == value);
